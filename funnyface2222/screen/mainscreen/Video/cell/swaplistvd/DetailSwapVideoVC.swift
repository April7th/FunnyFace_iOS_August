...
class DetailSwapVideoVC: UIViewController {
   ...
   // private let autoReplay = true
    ...
    @IBAction func shareLinkVideoSwap(){
        var linkUrlShare = "https://photo.gachmen.org/detailVideo/" + String(itemDataSend.id_sukien_video ?? "")
      ...
      //  imageUserAvatar.isUserInteractionEnabled = true
       // imageUserAvatar.addGestureRecognizer(tapProfile2)
        ...
        if #available(iOS 11.0, *) {
            ...
            playerView.topAnchor.constraint(equalTo: view.topAnchor, constant: 100).isActive = true
        }
        //______SONPIPI_____
